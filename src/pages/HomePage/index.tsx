...
import { FaqComponent } from '../../components/Kecil';
                    ...
                    <Row className='header-box d-flex align-items-center pt-lg-5'>
                        <Col lg='6'>
                            ...
                            <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nemo debitis ipsum nisi, praesentium ut provident.
                            </p>
                            <button
                        ...
                        <Col lg='6' className='pt-lg-0 pt-5'>
                            <img src={HeroImage} alt='HeroImage' className='animate__animated animate__fadeInUp' />
                        </Col>
                    </Row>
                </Container>
            </header>
                ...
                <Container>
                    <Row>
                        <Col>
                            ...
                            <p className='text-center'>Kelas terbaru yang ada di REMIRA STUDIO</p>
                        </Col>
                    </Row>
                    <Row>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className='ket d-flex justify-content-between align-items-center px-3 pb-3'>
                                        <p className='p-0 text-primary fw-bold'>{kelas.price}</p>
